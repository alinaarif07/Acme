export default function FAQs() {
  return (
    <section className="flex items-center justify-center min-h-screen py-12 bg-white dark:bg-black">
      <div className="max-w-3xl mx-auto px-4 text-left">
        <h1 className="text-4xl font-extrabold mb-6 text-black dark:text-white">Frequently Asked Questions</h1>
  ...
  <br/><br/>
  <span className="block mt-4 text-sm text-gray-600 dark:text-gray-400">
