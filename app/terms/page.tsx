  ...
  return (
    <div className="flex items-center justify-center min-h-screen py-12 bg-white dark:bg-black">
      <div className="max-w-3xl text-center px-4">
        <h1 className="text-3xl font-bold mb-6 text-black dark:text-white">Terms &amp; Conditions</h1>
        <p className="text-lg text-left text-black dark:text-white leading-relaxed space-y-4">
          ...
          <br/><br/>
          <span className="block mt-4 text-sm text-gray-600 dark:text-gray-400">This document was last updated on April 20, 2023.</span>
        </p>
      </div>
    </div>
  );
